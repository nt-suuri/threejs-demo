...
const Intro = () => {
    return (
        <DivInview>
            <div className="bg-gray-400 dark:bg-black p-5">
                ...
                <div className="w-full text-center uppercase content">
                    <div className="relative">
                        <div>
                            <h1 className="text-5xl md:text-7xl font-medium " style={{ fontFamily: "Venera" }}>Nasha Tech</h1>
                            <div className="h-5 overflow-hidden">
                                <h1 className="-translate-y-8 md:-translate-y-10 text-5xl md:text-7xl font-medium " style={{ fontFamily: "Venera" }}>Nasha Tech</h1>
                            </div>
                        </div>
                    ...
                    <div className="w-full flex items-center justify-center">
                        <div className="mx-5">
                            <dl className=" md:w-100 text-xs mt-5">
                                <dt> To make technology as accessible as possible for every people</dt>
                            </dl>
