    ...
    return (
        <div>
            {width && width < 700 ? <div className="absolute h-3/2">
                ...
                <animated.div style={fadeStyles} className="top-28 left-10 relative z-30 w-3/4 text w-96">
                ...
                <div className="absolute h-2/3">
                    ...
                    <animated.div style={fadeStyles} className="top-2/3 left-1/4 lg:left-64 mt-16 ml-5 relative z-30 w-96 ">
